package brother.heyflight.checktel.oauth;
...
public class NaverLoginService {
	private final static String CLIENT_ID = "Exzmu9FAJIMu_PLUQnRt";
	private final static String CLIENT_SECRET = "OnIPCMnrvI";
	private final static String REDIRECT_URI = "http://127.0.0.1/checktel/callback";
