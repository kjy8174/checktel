			...
			<div class="panel panel-info">
				<div class="panel-heading">
					...
					<div
						...
						<a href="<c:url value="/login.do" />"><p class="text-primary">로그인</p></a>
					</div>
				</div>
				<div class="panel-body">
					...
					<form id="joinForm" class="form-horizontal" name="joinForm" action="<c:url value="/join/confirm" />" method="POST" role="form">
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<label class="radio-inline"><input type="radio" name="sex" value="1">남</label>
								<label class="radio-inline"><input type="radio" name="sex" value="2">여</label>
							</div>
						</div>
