		...
		<div id="signupbox" style="display: block; margin-top: 50px"
			...
			<div class="panel panel-info">
				...
				<div class="panel-body">
					...
					<form id="joinForm" class="form-horizontal" name="joinForm" action="<c:url value="/join/done.do" />" method="POST" role="form">
						...
						<div class="form-group">
							...
							<label class="col-md-3 control-label" for="Birth">Birth</label>
							<div class="col-md-9" style="padding-top:7px;">
							<p>${user.memberBirth}</p>
							</div>
